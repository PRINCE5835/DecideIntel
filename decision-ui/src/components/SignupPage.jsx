      ...
      >
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl border border-slate-100/60 shadow-[0_8px_40px_rgba(0,0,0,0.06)] p-10">
          <div className="text-center mb-9">
            ...
            <h1 className="text-xl font-semibold text-slate-800 tracking-tight">Create your account</h1>
            <p className="text-sm text-slate-400 mt-1.5 font-normal">Join Decision Intelligence Hub</p>
